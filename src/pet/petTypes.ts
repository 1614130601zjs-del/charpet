...
export type SemanticPetEvent = {
  type: 'charpet.event'; action: PetAction; emotion?: PetMood; pose?: PetPose; intensity?: number;
  text?: string; timestamp?: number; need?: string; context?: Record<string, unknown>;
};
...
export type WorldbookEntry = { id: string; title: string; content: string; enabled: boolean; isTimeline?: boolean };
...
export type CharAssets = {
  avatar?: string; poses?: CharPoseAssets; expressions?: CharExpressionAssets; parts?: CharPartAssets; animations?: CharAnimationAssets;
  idle?: string; talk?: string; tap?: string; drag?: string; sleep?: string; wake?: string;
  happy?: string; sad?: string; angry?: string; surprised?: string; shy?: string; hungry?: string; eat?: string; lonely?: string;
  [key: string]: unknown;
};
